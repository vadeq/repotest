...
<html:form action="/publish/cisco.do?menuItem=0.1">
          ...
          <td>
           <table class="formProps" border="0" cellpadding="1" cellspacing="0" width="100%">
            ...
            <tr>
             <td>&nbsp;</td>
             <td>
             <html:link href="#" onclick="validateSendSearch(this.form,'searchCriteria','/publish/cisco.do');" styleClass="okButton"><img gif="search"/></html:link>
             <html:button onclick="validateSendSearch(this.form,'searchCriteria','/publish/search.do');"  property="search" styleClass="okButton" value="Search"/>
            </td>
            </tr>
           </table>
          </td>
   ...
   <tr>
    <td>
     ...
     <table border="1" cellpadding="0" cellspacing="1" width="100%" class="tbl" >
        ...
        <tr>
          <td class="clear"><input onclick="validateSendMove(this.form,'addSelectedOrigins','/publish/cisco.do');" type=checkbox name="selectedOrigins" value="<bean:write name="PublishMetadataAdapter" property="origin"/>" /></td>
  ...
  <tr>
    <td>
      ...
      <table  border="1" cellpadding="0" cellspacing="1" width="100%" class="tbl">
        ...
        <tr>
          <td class="clear"><input type=checkbox onclick="validateSendRemove(this.form,'removeSelectedOrigins','/publish/cisco.do');" name="selectedCartOrigins" checked="true" value="<bean:write name="cartMetaAdapter" property="origin"/>" /></td>
  ...
  <tr class="formMenu">
    <td>
     <table border="0" cellpadding="1" cellspacing="0" width="100%">
      <tr>
       <td>
        <html:link href="#" onclick="sendEvent('detectMissingCPN');" styleClass="okButton"><img gif="publish"/></html:link>
       </td>
       <td>
        <html:button onclick="validateSendRemove(this.form,'removeSelectedOrigins','/publish/cisco.do');"   property="remove" styleClass="okButton" value="Remove"/>
       </td>
      </tr>
     </table>
    </td>
