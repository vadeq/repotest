package zws.repository.ilink3;/*
 ...
 @author: arbind
 @version: 1.0
 Created on Mar 19, 2007 11:07:58 AM
 Copywrite (c) 2007 Zero Wait-State Inc. All rights reserved */

import zws.origin.Origin;

public class Ilink3Constants {
  ...
  public static String LAUNCH_EVENT_LISTENER = "launch-event-listener";
  ...
  public static String FILE_SPACE = "file-space";
  ...
  public static String LOCK_STATUS = "lock-status";
  public static String OWNER = "owner";
  
  public static String REMOTE_FILE_URL = "url";
  public static String REMOTE_FILE_INIQUE_ID = "id";
  public static String REMOTE_FILE_BINARY_NAME = "binary-name"; 
  ...
  public static String CONFIGURATION_AS_STORED = "as-stored";
  public static String CONFIGURATION_LATEST = "latest";

  //Dependency types
  public static String DEPENDENCIES_PROE_BOM = "proe-bom";
  public static String DEPENDENCIES_NONE = "none";
  public static String DEPENDENCIES_ALL = "all";
  public static String DEPENDENCIES_REQUIRED = "required";
  public static String EXPORT_DEPENDENCIES_REQUIRED = "req";
