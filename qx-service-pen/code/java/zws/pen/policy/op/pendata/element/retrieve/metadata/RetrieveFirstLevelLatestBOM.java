 ...
 * @author ptoleti
 */
public class RetrieveFirstLevelLatestBOM extends RetrieveMetadataOpBase {
  ...
  public Collection retrieveData(Repository sourceRepository, Origin sourceOrigin, Authentication id) throws Exception {
    RecorderUtil.logActivity(getQxCtx(),  sourceOrigin.getName(), "Retrieve first level latest BOM");
