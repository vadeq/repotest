...
@author: athakur
@version: 1.0
Created on January 9, 2004, 10:27 AM
...
public class GetValue extends ActionBase {
  ...
  private Object getValue() throws Exception { return getContext().get(getString("fieldname")); }
  ...
  public String getCtxDefaultFieldename() { return ctxDefaultFieldname; }
