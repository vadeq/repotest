...
public class TC10DatasetOrigin extends TC10Origin 
{

	public TC10DatasetOrigin() { super(); }

	public TC10DatasetOrigin( String domainName, 
							  String serverName, 
	...
	public String getDatasourceType() { return OriginMaker.FROM_TEAMCENTER_10_DATASET; }
	...
	public String getUniqueSequence() { return getUid() + delim + getItemId() + delim + getRevision()+ delim + getDatasetType()+ delim + getDatasetName(); }
	public String getUniqueIDDisplay() { return getUid() + " [" + getItemId() + "/" + getRevision() + "(" + getDatasetType() +")" + getDatasetName() + "]"; }
