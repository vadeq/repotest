 ...
 * @author ptoleti
 */
public class ExcludeAttributeOP extends PolicyMatchOpBase {
  ...
  public void execute() throws Exception {
    ...
    try {
      finalString = NO_DECISION;
      Metadata metaData = getMetaData();
      //printValues(metaData);
      {}//Logwriter.printOnConsole(metaData);
      {}//Logwriter.printOnConsole("Attribute name .... " + getAttributeName());
      {}//Logwriter.printOnConsole("Attribute value .... " + getAttributeValue());
      {}//Logwriter.printOnConsole("Metadata Attribute value .... " + metaData.get(getAttributeName()));
      if (null != metaData && null != metaData.get(getAttributeName())) {
        if (!getAttributeValue().equals(metaData.get(getAttributeName()))) {
          finalString = EXCLUDE_POLICY;
          {}//Logwriter.printOnConsole("Attribute value not matched.... ");
        } else {
          {}//Logwriter.printOnConsole("Attribute value matched.... ");
        }
      }
      {}//Logwriter.printOnConsole("finalString in ExcludeAttributeOP.... " + finalString);
