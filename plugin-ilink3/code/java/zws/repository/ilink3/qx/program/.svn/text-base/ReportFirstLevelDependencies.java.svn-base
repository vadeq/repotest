...
public class ReportFirstLevelDependencies extends QxInstruction {
  public ReportFirstLevelDependencies(Origin origin) {
    IntralinkOrigin ilinkOrigin  = (IntralinkOrigin) origin;
    setName("report-first-level-dependencies");
    ...
    set("configuration", Ilink3Constants.AS_STORED);
