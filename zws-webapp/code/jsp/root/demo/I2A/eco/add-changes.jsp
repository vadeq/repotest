...
<html:form action="/demo/I2A/eco/add-changes.do">
...
<% String title="conditional"; %>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="release2prototype">
<% title="Release For Prototype"; %>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="prototypeChange">
<% title="Change Prototype Design"; %>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="prototypeReplace">
<% title="Replace Prototype Design"; %>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="release2pilot">
<% title="Release For Pilot Production"; %>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="pilotChange">
<% title="Change Pilot Design"; %>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="pilotReplace">
<% title="Replace Pilot Design"; %>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="release2production">
<% title="Release For Production"; %>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="productionChange">
<% title="Change Active Design"; %>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="productionReplace">
<% title="Replace Active Design"; %>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="deactivate">
<% title="Deactivate Design"; %>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="markObsolete">
<% title="Mark Obsolete"; %>
</logic:equal>
...
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="release2prototype">
   <html:link href="#" onclick="javascript:sendEvent('release2Prototype')" styleClass="button">
	Release For Prototype
   </html:link>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="release2pilot">
   <html:link href="#" onclick="javascript:sendEvent('release2Pilot')" styleClass="button">
	Release For Pilot Production
   </html:link>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="release2production">
   <html:link href="#" onclick="javascript:sendEvent('release2Production')" styleClass="button">
	Release For Production
   </html:link>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="productionChange">
   <html:link href="#" onclick="javascript:sendEvent('productionChange')" styleClass="button">
	Change Active Design
   </html:link>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="productionReplace">
   <html:link href="#" onclick="javascript:sendEvent('productionReplace')" styleClass="button">
	Replace Active Design
   </html:link>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="deactivate">
   <html:link href="#" onclick="javascript:sendEvent('deactivate')" styleClass="button">
	Deactivate Design
   </html:link>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="markObsolete">
   <html:link href="#" onclick="javascript:sendEvent('markObsolete')" styleClass="button">
	Mark Obsolete
   </html:link>
</logic:equal>
