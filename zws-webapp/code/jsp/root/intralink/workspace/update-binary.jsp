...
<html:form action="/intralink/workspace/index.do" method="post" enctype="multipart/form-data">
...
<html:link href="index.do" styleClass="button"><img gif="cancel" alt="Cancel"/></html:link>
