 ...
 * @author ptoleti
 */
public class HasBOM extends PolicyMatchOpBase {
  ...
  public void execute() throws Exception {
    ...
    Metadata data = structureSource.reportLatestBOM(getQxCtx(), metaData.getName(), getAuthentication());
    Collection c = data.getSubComponents();
    if(c!=null && c.size() >0) {
      finalString = true;
    }
