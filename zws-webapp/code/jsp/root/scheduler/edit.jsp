...
<html:form action="/scheduler/edit.do" focus="processName">
<html:hidden property="ID"/>
<html:hidden property="event" value="save"/>
<html:hidden property="interactor" value="document.processing.schedule.edit"/>

<% String title="Update Job Schedule"; %>
<%@ include file="/web/include/header.jsp"%>
<table class="form" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td class="formTitle">&nbsp;Job: <bean:write name="hiChronJob" property="jobName"/>&nbsp;</td>
  </tr>
  <tr>
    <td>
