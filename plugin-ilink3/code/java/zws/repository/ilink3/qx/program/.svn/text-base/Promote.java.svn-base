 ...
 */
public class Promote extends QxInstruction {
   ...
   */
  public Promote(Origin origin, String promoteTo, String formFolderLocation, String dependencies, String configuration) {
