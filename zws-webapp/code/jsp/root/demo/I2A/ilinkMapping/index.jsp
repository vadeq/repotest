...
<html:form action="/demo/I2A/ilinkMapping/index.do" >
 ...
 <tr>
  <td valign="top" width="20%">
   <table class="form" border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <logic:iterate id="att" name="hiKLAIlinkMapping" property="intralinkAttributes" type="java.lang.String">
    <tr>
  ...
  <td valign="top" width="20%">
   <table class="form" border="0" cellpadding="0" cellspacing="" width="100%">
    <tr>
     <td class="formTitle" align="left" colspan="2"><div align="left"><nobr>&nbsp;Agile - <bean:write name="hiKLAIlinkMapping" property="agileClassName"/>  Attributes&nbsp;&nbsp;</nobr></div></td>
    </tr>
    <tr>
    ...
    <tr>
     <td class="item" valign="top">
      <table class="form" border="0" cellpadding="0" cellspacing="0" width="100%">
       <logic:iterate id="classname" name="hiKLAIlinkMapping" property="agileCADClasses" type="java.lang.String">
       <tr>
        <td class="item"><nobr><a class="button" href="index.do?agileClassName=<bean:write name="classname"/>"><bean:write name="classname"/></a></nobr></td>
       </tr>
       </logic:iterate>
      </table>
     </td>
     <td class="item" valign="top">
      <table class="form" border="0" cellpadding="0" cellspacing="0" width="100%">
       <logic:iterate id="att" name="hiKLAIlinkMapping" property="agileAttributes" type="java.lang.String">
       <tr>
  ...
  <td valign="top" width="50%">
   <table class="form" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr><td><b>&nbsp;Intralink</b></td><td><b>&nbsp;&nbsp;&nbsp;&nbsp;<bean:write name="hiKLAIlinkMapping" property="agileClassName"/></b></td></tr>
    <logic:iterate id="mapping" name="hiKLAIlinkMapping" property="mappings" type="zws.util.StringPair">
    <tr>
    ...
    <tr>
     <td class="item"><div><font color="maroon"><nobr><b><i>&nbsp;<bean:write name="hiKLAIlinkMapping" property="intralinkAttribute"/>&nbsp;</i></b></nobr></font></div></td>
     <td class="item"><div><font color="maroon"><nobr><b><i>&nbsp;&nbsp;&nbsp;&nbsp;<bean:write name="hiKLAIlinkMapping" property="agileAttribute"/>&nbsp;</i></b></nobr></font></div></td>
    </tr>
   </table>
  </td>
