...
public abstract class hiMetadata extends hiItem implements DocumentInterface {
    /*
  ...
  public hiMetadata() { super(); setHiState(STATE_INFO); }
  public hiMetadata(Document d) { super(null); doc = d; setHiState(STATE_INFO); }
