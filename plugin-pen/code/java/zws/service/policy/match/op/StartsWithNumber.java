 ...
 * @author ptoleti
 */
public class StartsWithNumber extends PolicyMatchOpBase {
  ...
  public void execute() throws Exception {
    ...
    if(metaDataAttrValue.length()!=0) {
      ...
      char firstChar = c[0];
      if(firstChar >= '0' && firstChar <= '9')isOK = true;
    }
    finalString = new Boolean(isOK).toString();
    {}//Logwriter.printOnConsole("finalString in StartsWithNumber.... " + finalString);
