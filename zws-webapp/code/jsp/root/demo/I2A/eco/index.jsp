...
<html:form action="/demo/I2A/eco/index.do">
    ...
    <table class="form" border="0" cellpadding="0" cellspacing="0" width="100%">
      ...
      <tr>
        <td>
          <table class="listItems" border="0" cellpadding="2" cellspacing="1" width="100%">
            <tr>
              <td colspan="4" class="listHeader"><nobr>&nbsp;Affected Items [<bean:write name="xeco" property="numberOfAffectedItems"/>]&nbsp;&nbsp;<html:link href="/demo/I2A/eco/add-changes.jsp" styleClass="button">add<%if (0<xeco.getNumberOfAffectedItems()) {%> more<%}%> changes</html:link>&nbsp;&nbsp;&nbsp;</nobr></td>
            </tr>
