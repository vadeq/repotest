...
ECHO %JAVA_HOME%\bin\java -classpath %CLASSPATH% zws.repository.teamcenter.proxy.TC10ProxyInterface download %USER% %PASSWORD% %ITEMID% %REV% %DATASET_TYPE% %DATASET_NAME% %FILE_NAME%
call %JAVA_HOME%\bin\java -classpath %CLASSPATH% zws.repository.teamcenter.proxy.TC10ProxyInterface download %USER% %PASSWORD% %ITEMID% %REV% %DATASET_TYPE% %DATASET_NAME% %FILE_NAME%
