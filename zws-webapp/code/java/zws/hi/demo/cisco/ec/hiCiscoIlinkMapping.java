...
public class hiCiscoIlinkMapping extends hiCiscoReport {
  ...
  public Collection getMappings() { return MapUtil.getCollectionFromMap(hiCiscoDemo.mappings, agileClassName); }
  ...
  private void addMapping(StringPair mapping) {
    ...
    Collection mappings = MapUtil.getCollectionFromMap(hiCiscoDemo.mappings, agileClassName);
