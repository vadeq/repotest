...
public class hiPublish extends hiReport {
...
/*
  public String status(){
    ...
    for (int idx=1; idx < generatedViewables.length; idx++) 
      criteria += SPACE + Names.CRITERIA_OR_DELIMITER + SPACE + Names.CRITERIA_GROUP_START_BLOCK + SPACE + "Name=" + (String)generatedViewables[idx] + SPACE + Names.CRITERIA_GROUP_END_BLOCK;
...
*/
  ...
  protected MetadataAdapter createNewMetadataAdapter() { return new AgilePOCMetadataAdapter(); }
  ...
  public String getPromotionLevel() { return promotionLevel; }
  public void setPromotionLevel(String s) { promotionLevel=s; }
  
  //ModelCheckOp op=null;
  private String dependentValue=IntralinkAccess.REQUIRED_DEPENDENCIES;
  private String promotionLevel = com.zws.application.Properties.get(com.zws.application.Properties.MODEL_CHECK_PROMOTION_LEVEL);
