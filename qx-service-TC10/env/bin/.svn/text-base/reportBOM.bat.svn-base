...
ECHO %JAVA_HOME%\bin\java -classpath %CLASSPATH% zws.qx.Test reportBOM %USER% %PASSWORD% %ITEMID% %REV% "%CONFIG%"
call %JAVA_HOME%\bin\java -classpath %CLASSPATH% zws.qx.Test reportBOM %USER% %PASSWORD% %ITEMID% %REV% "%CONFIG%"
