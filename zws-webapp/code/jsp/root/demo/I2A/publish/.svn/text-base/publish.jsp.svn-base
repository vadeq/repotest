...
<html:form action="/demo/I2A/publish/publish.do">
...
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="publishWIP">
<% title="Publish Work In Progress"; %>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="updateWIP">
<% title="Update Work In Progress"; %>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="replaceWIP">
<% title="Replace Work In Progress"; %>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="publishLibrary">
<% title="Publish Standard Library"; %>
</logic:equal>
...
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="publishWIP">
   <html:link href="#" onclick="javascript:sendEvent('publishWIP')" styleClass="button"><img src="/web/image/synchronized-green.gif" width="14" height="13" border="0"/>&nbsp;<img src="/web/image/synchronized-red.gif" width="14" height="13" border="0"/>
    Publish Work In Progress
   </html:link>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="updateWIP">
   <html:link href="#" onclick="javascript:sendEvent('updateWIP')" styleClass="button"><img src="/web/image/synchronized-green.gif" width="14" height="13" border="0"/>&nbsp;<img src="/web/image/synchronized-red.gif" width="14" height="13" border="0"/>
    Update Work In Progress
   </html:link>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="replaceWIP">
   <html:link href="#" onclick="javascript:sendEvent('replaceWIP')" styleClass="button"><img src="/web/image/synchronized-green.gif" width="14" height="13" border="0"/>&nbsp;<img src="/web/image/synchronized-red.gif" width="14" height="13" border="0"/>
    Replace Work In Progress
   </html:link>
</logic:equal>
<logic:equal name="hiKLAPublish2Agile" property="eventKey" value="publishLibrary">
   <html:link href="#" onclick="javascript:sendEvent('publishLibrary')" styleClass="button"><img src="/web/image/synchronized-green.gif" width="14" height="13" border="0"/>&nbsp;<img src="/web/image/synchronized-red.gif" width="14" height="13" border="0"/>
