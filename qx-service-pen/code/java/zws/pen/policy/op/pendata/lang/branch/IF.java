 ...
 */
package zws.pen.policy.op.pendata.lang.branch;
...
public class IF extends PENDataOpBase {
  ...
  protected boolean evaluateIF() throws Exception {
    if (null!=getGlobalStatusName()) return evaluateGlobalStatus();
  ...
  protected boolean evaluateGlobalStatus() throws Exception {
    String statusValue = getPenData().getStatus(getGlobalStatusName());
  ...
  public String getGlobalStatusName() { return globalStatusName;}
  public void setGlobalStatusName(String s) { globalStatusName = s;}
  ...
  private String globalStatusName = null;
}
