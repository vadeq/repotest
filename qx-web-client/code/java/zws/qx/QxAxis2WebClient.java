...
//refactor to implement all Axis 2 logic.
// changed by pavan as build failed.
//public class QxAxis2WebClient extends QxWebClient {
public class QxAxis2WebClient  {
  private static QxAxis2WebClient qxClient = new QxAxis2WebClient();

  private QxAxis2WebClient() {}
  ...
  public static QxAxis2WebClient materializeClient() { return qxClient; }
