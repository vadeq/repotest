...
public class Parser extends DefaultHandler {
  ...
  private Map attributeMap(String tagName, Attributes atts) throws ParserException {
    ...
    catch (Exception e){ throw new ParserException("Typecast error, unknown element found in attribute list mappings! " + e.getMessage()); }
    ...
    for (int i = 0; i < atts.getLength(); i++){
      ...
      catch (Exception e){ throw new ParserException("Typecast error, unknown element found in property mapping! " + e.getMessage()); }
      ...
      try { resultMapping.put(propertyName, aMap.convertValue(value)); }
        ...
        throw new ParserException("Can not convert given value: \""+value+"\" to specified type: " + aMap.getType()+ " for attribute: " + xmlName + " in tag: " + tagName + "! " + e.getMessage());
      }
    }
  ...
  public void startElement(String namespaceURI, String localName, String qName, Attributes atts)throws ParserException {
    ...
    if (null==targeting.getTargetObject() && 0 < stack.size()){
      ...
      catch (Exception e) { throw new ParserException("Typecast exception, unknown object placed in stack! " + e.getMessage()); }
    ...
    try { actor.initialize(attributeMap(qName, atts)); o = actor.process(); }
	    ...
	    o = actor.process();
	      ...
	      throw new ParserException("Could not execute action for tag: " + qName + "! " + e.getMessage());
	    }
    }
  ...
  public void endElement(String namespaceURI, String localName, String qName) throws ParserException {
    ...
    catch (Exception e) { throw new ParserException("Could not place " + qName + " into system!\n" + e.getMessage()); }
  }
