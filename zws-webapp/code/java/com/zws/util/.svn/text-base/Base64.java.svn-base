...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    public static byte[] decode( String s, boolean gzipCompressed )
    {
        ...
        // Otherwise: Base64 -> G(un)Zip -> ByteArray
        byte[] bytes = null;
        java.io.ByteArrayOutputStream baos  = new java.io.ByteArrayOutputStream();
        ...
        try
        {
            ...
            Base64.OutputStream b64os           = new Base64.OutputStream( gzos, DECODE );
    ...
    public static class OutputStream extends java.io.FilterOutputStream
    {
        ...
        {
            if( flushed )
                throw new java.io.IOException( "Base64.OutputStream has already been flushed. No more writing is allowed." );
