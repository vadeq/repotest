...
ECHO %JAVA_HOME%\bin\java -classpath %CLASSPATH% zws.qx.Test find %USER% %PASSWORD% %ITEMID% %REV%
call %JAVA_HOME%\bin\java -classpath %CLASSPATH% zws.qx.Test find %USER% %PASSWORD% %ITEMID% %REV%
